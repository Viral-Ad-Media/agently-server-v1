...
(function() {
  ...
  function renderLeadForm() {
    ...
    form.innerHTML = '<div class="lfTitle">Quick details</div>'
      ...
      + '<div class="lfActions"><button class="lfSkip" type="button" id="lfSkip">Maybe later</button><button class="lfSubmit" type="button" id="lfSubmit">Save details</button></div>';
    ...
    subBtn.onclick = sub;
    form.querySelector('#lfSkip').onclick = function() { form.remove(); leadFormVisible = false; ci.disabled = false; sb.disabled = !ci.value.trim(); };
  ...
  if (vmBtn2) vmBtn2.onclick = function() { if (vmActive) stopVM(); else void startVM(); };
