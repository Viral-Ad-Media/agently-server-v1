 ...
 */
async function verifyCallerIdStart(phoneNumber, friendlyName) {
  const params = {
    PhoneNumber: phoneNumber,
    FriendlyName: friendlyName || `Agently verified number`,
    // CallDelay: '0',  // seconds before Twilio calls — 0 = immediate
  };

  // POST /OutgoingCallerIds.json
  // Response: { validation_code, call_sid, phone_number, account_sid, ... }
