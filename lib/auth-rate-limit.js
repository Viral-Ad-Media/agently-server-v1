...
/**
 * The caller's IP. "Only for bucketing" was the old note here, and it was the
 * wrong reassurance: bucketing IS the limit. This used to read the client-
 * written end of X-Forwarded-For, so rotating that header per request reset
 * login_ip, code_send_ip, code_verify_ip, register_ip and password_reset_ip
 * to zero every time. See lib/client-ip.js.
 */
