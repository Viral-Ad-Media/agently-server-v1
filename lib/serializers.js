...
function serializeAgent(row, faqs = []) {
  ...
  return {
    ...
    escalationWorkingHoursStart: row.escalation_hours_start || '09:00',
    escalationWorkingHoursEnd: row.escalation_hours_end || '17:00',
  };
}
...
function buildDefaultAgent() {
  return {
    ...
    isActive: false,
    webhookUrl: '',
    escalationWorkingHoursStart: '09:00',
    escalationWorkingHoursEnd: '17:00',
  };
}
