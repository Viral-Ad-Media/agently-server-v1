...
function mapTwilioError(err, fallback = "Twilio request failed.") {
  ...
  if (
    ...
    message =
      "SMS to this destination is blocked because SMS Geo Permissions are not enabled in Twilio Console. Enable the country manually, then confirm it in Agently.";
    ...
    message =
      "Outbound voice calling to this destination is not enabled for this Twilio account. Enable low-risk voice dialing permissions for the destination country or choose another destination.";
    ...
    message =
      "This number requires regulatory information before all features can be activated.";
    ...
    message =
      "The destination number is not a valid E.164 phone number. Use a format like +14155551234.";
    ...
    message =
      "The selected business number could not be used to start the call. It may be on a different voice account, not fully configured, or not enabled for outbound calling yet.";
    ...
    message =
      "Twilio authentication failed. Check the platform Twilio credentials and subaccount configuration.";
    ...
    message =
      "This request could not be completed because of a quota or rate limit. Please try again later.";
    friendlyCode = "QUOTA_OR_RATE_LIMIT";
  } else if (lower.includes("webhook")) {
    message =
      "Twilio could not reach the configured webhook. Check API_URL and public HTTPS routing.";
