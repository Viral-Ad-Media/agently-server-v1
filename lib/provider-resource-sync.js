...
async function runPhase2ProviderSync({ organizationId, startDate = null, endDate = null, providers = ["mapping", "twilio", "app"], billingPeriod = null } = {}) {
  ...
  return {
    ...
    important: [
      ...
      "OpenAI, ElevenLabs, AWS, and Supabase provider bills still require live runtime usage capture; provider dashboards alone cannot reliably split a shared account by organization.",
    ],
  };
}
