...
function inferRuntimeBusinessFacts(context = {}) {
  ...
  add(
    "If the selected KB does not contain enough information to answer a business-specific question, say that the detail is not available in the selected knowledge base and offer to take a message or schedule a callback.",
  );
