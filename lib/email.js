...
/*
 * ISSUE 6 — signup and reset emails still linked to a *.vercel.app preview URL.
 * Every fallback in this file pointed there, and VERCEL_URL resolves to the
 * per-deployment hostname (agently-frontend-abc123.vercel.app), which changes
 * on every deploy and is what you were seeing in your inbox.
 *
 * The custom domain is now the default, and VERCEL_URL is no longer consulted
 * — a per-deployment preview hostname is never the right thing to email a
 * customer. Override with FRONTEND_URL if you need to.
 */
const DEFAULT_APP_URL = "https://www.agentlycall.com";
