 ...
 * `agently-ws-server` deployment the environment was incomplete /
 ...
 * billing insert, and every OpenAI / ElevenLabs / runtime usage row was
...
function resolveRequestTimeoutMs() {
  const value = Number(process.env.SUPABASE_REQUEST_TIMEOUT_MS || 12000);
